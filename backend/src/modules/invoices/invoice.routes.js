...
invoiceRouter.post('/:id/payments', requireRole(EXTENDED_WRITE_ROLES), memoryUpload.single('file'), invoiceController.addPayment);
...
invoiceRouter.post('/:id/documents', requireRole(EXTENDED_WRITE_ROLES), memoryUpload.single('file'), invoiceController.addDocument);
invoiceRouter.delete('/:id/documents/:docId', requireRole(EXTENDED_WRITE_ROLES), invoiceController.removeDocument);
